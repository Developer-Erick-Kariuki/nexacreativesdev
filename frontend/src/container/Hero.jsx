...
const Hero = () => {
  return (
    <motion.section
      ...
      className="mb-16 bg-[url(/gradient.png)] bg-cover rounded-b-xl px-8 overflow-hidden  "
    >
      <Container>
        <div className="w-full py-20 mx-auto justify-between items-center flex flex-col md:flex-row ">
          <div className="flex w-full md:mt-0 flex-col">
            <motion.h1
              ...
              transition={{ duration: 1, ease: "easeInOut" }}
              className="text-5xl md:text-6xl text-center capitalize md:text-start max-w-xl font-bold mt-12 mb-16"
            >
